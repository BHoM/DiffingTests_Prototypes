...
namespace Tests
{
    internal static partial class RevitDiffing
    {
        public static void RevitDiffing_basic()
        {
            ...
            int numElements = 10;
            List<IBHoMObject> pastObjects = Utils.GenerateRandomObjects(typeof(BH.oM.Adapters.Revit.Elements.ModelInstance), numElements);
            List<IBHoMObject> followingObjs = Utils.GenerateRandomObjects(typeof(BH.oM.Adapters.Revit.Elements.ModelInstance), numElements);
